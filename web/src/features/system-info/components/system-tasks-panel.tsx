...
const LOADING_ROW_IDS = ['loading-1', 'loading-2', 'loading-3', 'loading-4']
...
const TYPE_LABEL: Record<string, string> = {
  ...
  upstream_probe: 'Upstream route probing',
  upstream_reconcile: 'Upstream route reconciliation',
  upstream_daily: 'Upstream daily reconciliation',
}
