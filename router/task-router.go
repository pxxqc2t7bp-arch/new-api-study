...
func SetTaskRouter(router *gin.Engine) {
	...
	{
		taskReadRouter.GET("/:key", middleware.AppGrantOrTokenTaskRetrievalAuth("", "key"), controller.GetTask)
		taskReadRouter.GET("/:key/artifacts", middleware.AppGrantOrTokenTaskRetrievalAuth("", "key"), controller.GetTaskArtifacts)
	}
