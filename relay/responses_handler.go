...
func ResponsesHelper(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.NewAPIError) {
	...
	if info.RelayMode == relayconstant.RelayModeResponsesCompact {
		helper.ApplySmartRouterActualModelPricing(c, info, info.GetEstimatePromptTokens(), responsesReq.GetTokenCountMeta())
...
func ConsumeResponsesQuota(c *gin.Context, info *relaycommon.RelayInfo, usage *dto.Usage) {
	...
	helper.ApplySmartRouterActualModelPricing(c, info, info.GetEstimatePromptTokens(), meta)
