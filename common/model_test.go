...
func TestIsImageGenerationModelRecognizesSeedream(t *testing.T) {
	assert.True(t, common.IsImageGenerationModel("doubao-seedream-5-0-pro-260628"))
	assert.True(t, common.IsImageGenerationModel("doubao-seedream-4-5-251128"))
	assert.False(t, common.IsImageGenerationModel("doubao-seedance-2-5-260628"))
}
